...
<div class="main">
 <section>
	<div class="main-banner" style="background-image: url(img/webp/main-banner-bg_result.webp);">
	   <div class="main-banner-inner">
	   	<div class="main-banner-announce">
	   		<img src="img/anounce-icon.png" alt="">
	   		<p>We are <span>2 years</span> OLD!</p>
	   	</div>
		  <div class="main-banner-top">
			 ...
			 <a href="https://play.canvaisland.com/">
 ...
 <section>
	<div class="whatis" style="background-image: url(img/webp/whatis-bg_result.webp);">
	   <div class="whatis-inner">
		  <div class="whatis-title title">
			 <h2>WHAT IS CANVAISLAD</h2>
			 <p>WHAT IS CANVAISLAD</p>
		  </div>
		  <div class="whatis-text">
		     CanvaIsland is a progressive decentralized ecosystem consist of Metaverse, DeFi platform, Canva Wallet and other products powered by the Ethereum blockchain. Within the CanvaIsland metaverse, users can create your own town, explore world, monetize their content and earn tokens. Or stake your tokens and NFT on Canva dApp..</div>
		  <div class="whatis-video">
			 <iframe width="560" height="315" src="https://www.youtube.com/embed/0T52NEGaCUs"
				title="YouTube video player" frameborder="0"
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
				allowfullscreen></iframe>
			 <div class="what-is-bottom-text">*Browser free-to-play life sim farming RPG, coming to PC & mobile soon
			 </div>
			 <div class="whatis-video-bg">
				<img src="img/canva_player.webp" alt="">
			 </div>
		  </div>
	   </div>
	</div>
 ...
 <section>
	<div class="genesis" style="background-image: url(img/webp/genesis-bg_result.webp);">
	   <div class="container">
		  <div class="genesis-inner">
			 <div class="genesis-l content-col">
				...
				<div class="genesis-title title content-col-title">
				   <h2>GENESIS ISLAND</h2>
				   <p>GENESIS ISLAND</p>
				</div>
				<div class="genesis-text content-col-text">
					Become the owner of unique NFT-land in the CanvaIsland metaverse, build your city and monetize your content. By purchasing plots on a different islands, users will get access to the functionality of this island: Building objects, ability to sell their NFTs. Many ways to earn $CANVA tokens. Access to closed community among land owners and much more!
				<br />
					Our first island consists of 256 lands that have been successfully sold and are currently being traded on OpenSea. A new island with 1024 lands will be added soon</div>
				...
				<div class="genesis-btns content-col-btns">
					<a href="<?=$contentData["links"]["opensea_island"];?>">
			 ...
			 <a href="/island/view">
				 <div class="genesis-r">
					<div class="genesis-img">
					   <img src="img/webp/genesis-img_result.webp" alt="">
 ...
 <section>
	<div class="profile" style="background-image: url(img/webp/profile-bg_result.webp);">
	   <div class="container">
		  <div class="profile-inner">
			 ...
			 <div class="profile-r">
				<div class="content-col">
				   ...
				   <div class="profile-text content-col-text">
						10,000 unique avatars from our team that will highlited you and give you many advantages. In addition, there will be integration of other PFP projects and directions into our CanvaIsland metaverse. The possibility of earning with your avatars.
				   </div>
				   ...
				   <div class="profile-btns content-col-btns">
					  <a href="https://canvaisland.com/avatars#mint" target="_blank">
	   ...
	   <div class="container">
		  <div class="nametoken-inner">
			 <div class="nametoken-l">
				<div class="content-col">
				   <div class="nametoken-suptitle content-col-suptitle">Heart of ecosystem</div>
				   <div class="nametoken-title title content-col-title">
					  <h2><span class="green"><?=$contentData["TokenName"];?></span> token</h2>
					  <p><?=$contentData["TokenName"];?> token</p>
				   </div>
				   <div class="nametoken-text content-col-text">
						$CANVA is an ERC-20 token built on the Ethereum blockchain. It is the main utility token in our progressive ecosystem. Canva token is used in our metaverse, mobile wallet, as well as for buying NFT, staking and more. Canva has a stable economic model and deflationary mechanism.
					<br />
						Tokens for Pinksale Fair Launch and Liquidity tokens has been minted previously. LP lock for 365 days. 900 million tokens creating by blocks. Token emission under DAO control.
				   </div>
				   <a href="/token" class="nametoken-link content-col-link">
					  More about <?=$contentData["TokenName"];?>
					  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21"
						 fill="none">
						 <path
							d="M12.6703 6C12.399 6.00007 12.1548 6.16451 12.0527 6.41585C11.9507 6.66719 12.011 6.95532 12.2055 7.14453L14.4008 9.33985H4.01015C3.76972 9.33645 3.5461 9.46276 3.42489 9.67042C3.30368 9.87809 3.30368 10.1349 3.42489 10.3426C3.5461 10.5503 3.76972 10.6766 4.01015 10.6732H14.4008L12.2055 12.8685C12.0313 13.0357 11.9611 13.284 12.022 13.5176C12.083 13.7512 12.2654 13.9337 12.499 13.9946C12.7327 14.0555 12.981 13.9853 13.1482 13.8112L16.4229 10.5365C16.5879 10.4107 16.685 10.2153 16.6855 10.0078C16.686 9.80032 16.5899 9.60443 16.4255 9.47786C16.4242 9.47698 16.4229 9.47612 16.4216 9.47525L13.1482 6.20181C13.0226 6.07279 12.8503 6.00001 12.6703 6Z"
				...
				<div class="nametoken-diagramm">
				   <div class="nametoken-diagram-img">
					  <svg xmlns="http://www.w3.org/2000/svg" width="293" height="294" viewBox="0 0 293 294"
						 fill="none">
						 <circle cx="146.5" cy="147" r="146.5" fill="#D479DC" class="nametoken-diagram-img-8" data-target="1" />
						 <path
							...
							fill="#79DCAC" class="nametoken-diagram-img-1" data-target="2"/>
						 <path
						 ...
						 <path
							...
							fill="#79ACDC" class="nametoken-diagram-img-3" data-target="4"/>
						 <path
						 ...
						 <path
							...
							fill="#EAB585" class="nametoken-diagram-img-7" data-target="5"/>
					  </svg>
				   </div>
				   <div class="nametoken-diagram-item nametoken-diagram-item-1" data-id="1">
				   ...
				   <div class="nametoken-diagram-item nametoken-diagram-item-2" data-id="2">
				   ...
				   <div class="nametoken-diagram-item nametoken-diagram-item-3" data-id="3">
				   ...
				   <div class="nametoken-diagram-item nametoken-diagram-item-4" data-id="4">
				   ...
				   <div class="nametoken-diagram-item aifs nametoken-diagram-item-5" data-id="5">
				   ...
				   <div class="nametoken-diagram-item aifs nametoken-diagram-item-6" data-id="6">
					  <div class="nametoken-diagram-item-title">PreSale</div>
				   ...
				   <div class="nametoken-diagram-item aifs nametoken-diagram-item-7" data-id="7">
				   ...
				   <div class="nametoken-diagram-item aifs nametoken-diagram-item-8" data-id="8">
 ...
 <section>
	<div class="main-favs">
	   <div class="main-favs-row">
		  <div class="main-favs-row-bg" style="background-image: url(img/webp/main-favs-1_result.webp);"></div>
		  <div class="main-favs-row-bg-mob" style="background-image: url(img/webp/main-favs-mob-1_result.webp);"></div>
		  <div class="container">
			 <div class="main-favs-row-inner">
				<div class="main-favs-row-content">
				   ...
				   <div class="main-favs-row-text">
					Token Swaps on CanvaIsland dApp are a simple way to trade one  token for another via automated liquidity pools in Ethereum with minimal slippage and fees.
				   </div>
				</div>
			 </div>
		  </div>
	   ...
	   <div class="main-favs-row">
		  <div class="main-favs-row-bg" style="background-image: url(img/webp/main-favs-2_result.webp);"></div>
		  <div class="main-favs-row-bg-mob" style="background-image: url(img/webp/main-favs-mob-2_result.webp);"></div>
		  <div class="container">
			 <div class="main-favs-row-inner">
				<div class="main-favs-row-content">
				   <div class="main-favs-row-title title">
				   ...
				   <div class="main-favs-row-text">
					Canva Pools is a less resource-intensive alternative to mining. It lets you use your tokens to earn more tokens with high APR. Simply put in pool your cryptocurrency to receive rewards. From the very beginning, a user could stake only $CANVA tokens in exchange for more $CANVA
				   </div>
				</div>
			 </div>
		  </div>
	   ...
	   <div class="main-favs-row">
		  <div class="main-favs-row-bg" style="background-image: url(img/webp/main-favs-3_result.webp);"></div>
		  <div class="main-favs-row-bg-mob" style="background-image: url(img/webp/main-favs-mob-3_result.webp);"></div>
		  <div class="container">
			 <div class="main-favs-row-inner">
				<div class="main-favs-row-content">
				   <div class="main-favs-row-title title">
				   ...
				   <div class="main-favs-row-text">
					Canva Referral Program allows you to invite friends and earn 10% commission from their friends earnings on Staking Pools. Within a few months we will be adding an affiliate program to our metaverse, NFT minting and more
		  ...
		  <div class="container">
			 <div class="roadmap-content">
				<div class="roadmap-title title">
				   <p>CanvaIsland roadmap</p>
				   <p>CanvaIsland roadmap</p>
				</div>
				<div class="roadmap-text">We create a global ecosystem with progressive metaverse</div>
			 </div>
		  ...
		  <div class="enter-inner">
			 <div class="enter-l">
				<div class="enter-title title">
				   ...
				   <p>ENTER TO
					  DEFI WORLD WITH <span class="green">CANVA WALLET</span>
				   </p>
				   <p>ENTER TO DEFI WORLD
					 WITH CANVA WALLET</p>
				</div>
				<div class="enter-text">
					Are you looking for a  non-custodial multiwallet that's secure, user-friendly and gives you access to a wide range of crypto assets? Look no further than Canva Wallet! Our crypto-wallet is designed with the latest technology to ensure that your assets are secure and always accessible.
			<a href="/wallet" class="nametoken-link content-col-link">
					  More about Canva Wallet					  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
						 <path d="M12.6703 6C12.399 6.00007 12.1548 6.16451 12.0527 6.41585C11.9507 6.66719 12.011 6.95532 12.2055 7.14453L14.4008 9.33985H4.01015C3.76972 9.33645 3.5461 9.46276 3.42489 9.67042C3.30368 9.87809 3.30368 10.1349 3.42489 10.3426C3.5461 10.5503 3.76972 10.6766 4.01015 10.6732H14.4008L12.2055 12.8685C12.0313 13.0357 11.9611 13.284 12.022 13.5176C12.083 13.7512 12.2654 13.9337 12.499 13.9946C12.7327 14.0555 12.981 13.9853 13.1482 13.8112L16.4229 10.5365C16.5879 10.4107 16.685 10.2153 16.6855 10.0078C16.686 9.80032 16.5899 9.60443 16.4255 9.47786C16.4242 9.47698 16.4229 9.47612 16.4216 9.47525L13.1482 6.20181C13.0226 6.07279 12.8503 6.00001 12.6703 6Z" fill="#BAD34A"></path>
					  </svg>
				   </a>
				</div>
				<div class="enter-items">
				   <div class="enter-item">
					  <p>4.9 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
							fill="none">
							<path
				...
				<div class="enter-img mob">
				   <img src="img/webp/wallet-img_result.webp" alt="">
				</div>
				<div class="enter-btns">
				   <a href="<?=$contentData["links"]["googleplay"];?>" class="enter-btn">
					  <img src="img/webp/google-btn_result.webp" alt="">
				   </a>
				   <a href="<?=$contentData["links"]["appstore"];?>" class="enter-btn">
					  <img src="img/webp/appstore-btn_result.webp" alt="">
				   </a>
				</div>
			 </div>
			 <div class="enter-r">
 ...
 <section>
	<div class="main-bottom-block" style="background-image: url(img/webp/main-bottom-block-bg_result.webp);">
	   <div class="container">
				   ...
				   <div class="swiper-slide">
				     <a href="https://uniswap.org/" target="_blank">
					  <div class="main-bottom-block-slide"> 
						 <img src="img/webp/main-bottom-block-1_result.webp" alt="">
					  </div>
					</a>
				   </div>
				   <div class="swiper-slide"> 
				    <a href="https://www.pinksale.finance/" target="_blank">
					  <div class="main-bottom-block-slide">
						 <img src="img/webp/main-bottom-block-2_result.webp" alt="">
					  </div>
					</a>
				   </div>
				   <div class="swiper-slide">
				    <a href="http://certik.com/" target="_blank">
					  <div class="main-bottom-block-slide"> 
						 <img src="img/webp/main-bottom-block-3_result.webp" alt="">
					  </div>
					</a>
				   </div>
				   <div class="swiper-slide">
				    <a href="https://coinmarketcap.com" target="_blank">
					  <div class="main-bottom-block-slide"> 
						 <img src="img/webp/main-bottom-block-4_result.webp" alt="">
					  </div>
					</a>
				   </div>
				   <div class="swiper-slide">
					<a href="https://cfg.ninja/" target="_blank">
					  <div class="main-bottom-block-slide">
						 <img src="img/webp/main-bottom-block-5_result.webp" alt="">
					  </div>
					</a>
				   </div>				   
				   <div class="swiper-slide"> 
				    <a href="https://www.coingecko.com" target="_blank">
					  <div class="main-bottom-block-slide">
						 <img src="img/webp/coingecko_result.webp" alt="">
					  </div>
					</a>
				   </div>
				   <div class="swiper-slide"> 
				    <a href="https://www.dextools.io/" target="_blank">
					  <div class="main-bottom-block-slide">
						 <img src="img/webp/dextools_result.webp" alt="">
					  </div>
					</a>
				   </div>
				   <div class="swiper-slide"> 
				    <a href="https://www.dexview.com/" target="_blank">
					  <div class="main-bottom-block-slide">
						 <img src="img/webp/dexview_result.webp" alt="">
					  </div>
					</a>
				   </div>
				</div>
