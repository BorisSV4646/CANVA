...
addTokenButton.addEventListener("click", function () {
  const tokenAddress = "0x5959bC9A10A89cccCfdb6b2BB458F34E52504441"; // Адрес токена
  ...
  if ($(this).hasClass("unstake")) {
    ...
    inputField.addEventListener("input", async function () {
      ...
      const allowance = await tokenContract.methods
        .allowance(waleetAdress, "0xC6d0cB13D3302ff3fA62AC8bAcb02F8d0c16995B")
        .call();
...
async function getContract(web3provider) {
  const web3 = new Web3(web3provider);
  const stakeContractAddress = "0xC6d0cB13D3302ff3fA62AC8bAcb02F8d0c16995B";
...
// async function listenToWithdrawEvents() {
//   let totalStaked = 0;
//   const tokenContract = await getContract(
//     "https://goerli.blockpi.network/v1/rpc/public"
//   );

//   tokenContract.on("Deposit", (address, amount, event) => {
//     totalStaked += amount;
...
//   const element = document.getElementById("totalStaked");
//   element.innerHTML = String(totalStaked);
// }
